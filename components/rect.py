from config import thumboffset
...
class Rect(object):
    ...
    def self_move(self, x0, y0):
        self.top = int(self.top + y0)
        self.bottom = int(self.bottom + y0)
        self.right = int(self.right + x0)
        self.left = int(self.left + x0)
        self._update_dims()
